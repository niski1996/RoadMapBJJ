    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoInfoRow", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AdditionalUserInfoRow_AdditionalUserInfoId",
                        column: x => x.AdditionalUserInfoId,
                        principalSchema: "main",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsertTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    VideoInfoId = table.Column<Guid>(type: "uuid", nullable: false),
                    AdditionalUserInfoRowId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoRow", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VideoRow_AdditionalUserInfoRow_AdditionalUserInfoRowId",
                        column: x => x.AdditionalUserInfoRowId,
                        principalSchema: "main",
                        principalTable: "AdditionalUserInfoRow",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VideoRow_VideoInfoRow_VideoInfoId",
                        column: x => x.VideoInfoId,
                        principalSchema: "main",
                        principalTable: "VideoInfoRow",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AdditionalUserInfoId",
                schema: "main",
                table: "AspNetUsers",
                column: "AdditionalUserInfoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoRow_AdditionalUserInfoRowId",
                schema: "main",
                table: "VideoRow",
                column: "AdditionalUserInfoRowId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoRow_VideoInfoId",
                schema: "main",
                table: "VideoRow",
                column: "VideoInfoId");
        }
